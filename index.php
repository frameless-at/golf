...
<div class="element">
 ...
 <table width="300" border="1" cellspacing="1" cellpadding="1">
  ...
  <div class="element">  
	...
	<div class="option-container">
	    <select class="af-select af-formvalue  " name="element-32" id="element-32" style="color:#000000;font-family:Verdana;font-size:0.8em;font-weight:normal;width:272px;border-style:solid; border-color:#dcdcdc;-moz-border-radius:5px;-khtml-border-radius:5px;-webkit-border-radius:5px;border-radius:5px;border-width:1px;padding:5px;" >
	      <option value="1" selected="selected">2025</option>
  ...
  <div class="element">  
	...
	<div class="option-container">
	    <select class="af-select af-formvalue  " name="element-15" id="element-15" style="color:#000000;font-family:Verdana;font-size:0.8em;font-weight:normal;width:272px;border-style:solid; border-color:#dcdcdc;-moz-border-radius:5px;-khtml-border-radius:5px;-webkit-border-radius:5px;border-radius:5px;border-width:1px;padding:5px;" >
	      <option value="1" selected="selected">Standard: EUR 199,- *</option>
	      <option value="2">Studenten bis 26: EUR 149,- *</option>
	      <option value="3">Jugendliche bis 21: EUR 99,-</option>
	      <option value="4">Kinder bis 12: EUR 0,-</option>
        </select>
...
<div class="element">  
	<label id="label-element-51" class="label" style="color:#ea1c2f;font-family:Trebuchet MS;font-size:1.0em;font-weight:normal;">
	<span class="labelelementvalue">Extragolf VIP-Card</span><span class="required"></span></label>

	<div class="errormessage" id="errormessage-element-51"></div>

	<div class="option-container">
	    <select class="af-select af-formvalue  " name="element-51" id="element-51" style="color:#000000;font-family:Verdana;font-size:0.8em;font-weight:normal;width:272px;border-style:solid; border-color:#dcdcdc;-moz-border-radius:5px;-khtml-border-radius:5px;-webkit-border-radius:5px;border-radius:5px;border-width:1px;padding:5px;" >
	      <option value="1" selected="selected">nein</option>
	      <option value="2">ja, um zusätzlich EUR 30,-</option>
        </select>

	</div>
    <input style="display:none" value="51" checked="" name="requiredelement[]" id="requiredelement-51" type="checkbox">
</div>

<div class="element">  
	<label id="label-element-52" class="label" style="color:#ea1c2f;font-family:Trebuchet MS;font-size:1.0em;font-weight:normal;">
	<span class="labelelementvalue">Greenfee-Package </span><span class="required"></span></label>

	<div class="errormessage" id="errormessage-element-52"></div>

	<div class="option-container">
	    <select class="af-select af-formvalue  " name="element-52" id="element-52" style="color:#000000;font-family:Verdana;font-size:0.8em;font-weight:normal;width:272px;border-style:solid; border-color:#dcdcdc;-moz-border-radius:5px;-khtml-border-radius:5px;-webkit-border-radius:5px;border-radius:5px;border-width:1px;padding:5px;" >
	      <option value="1" selected="selected">nein</option>
	      <option value="2">ja, um zusätzlich EUR 69,-</option>
        </select>

	</div>
    <input style="display:none" value="52" checked="" name="requiredelement[]" id="requiredelement-52" type="checkbox">
</div>


<div class="element">
	<label id="label-element-31" class="label" style="color:#ea1c2f;font-family:Trebuchet MS;font-size:1.0em;font-weight:normal;">
	<span class="labelelementvalue">Promotioncode</span><span class="required"></span></label>

	<div class="errormessage" id="errormessage-element-31"></div>

	<div class="option-container">
	<input class="af-inputtext af-formvalue  " name="element-31" id="element-31" placeholder="" value="<?php echo $_GET["promotioncode"]; ?>" style="color:#000000;font-family:Verdana;font-size:0.8em;font-weight:normal;width:260px;border-style:solid; border-color:#dcdcdc;-moz-border-radius:5px;-khtml-border-radius:5px;-webkit-border-radius:5px;border-radius:5px;border-width:1px;padding:5px;" type="text"></div>
...
<div class="element">
  ...
  <option value="1" selected="selected">Golfer mit Platzerlaubnis</option>
  <option value="2">Golfer mit Turniererlaubnis</option>
  <option value="3">Golfer mit Stammvorgabe (HCP)</option>
...
<div id="div1">
	...
	<span class="labelelementvalue">Stammvorgabe (HCP)</span><span class="required"></span></label>
...
<div class="element">
	...
	<span class="labelelementvalue">* ab dem vollendenten 21. Lebensjahr inkl. ÖGV-Abgaben und Spesen von insgesamt EUR 50,-</span>
	<span class="required"></span></label>
</div>
